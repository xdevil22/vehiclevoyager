        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-neutral-800 mb-4">
              ...
              the perfect vehicle for their adventures. Our platform aggregates
            ...
            <p className="text-neutral-800 mb-4">
              ...
              vehicle rentals – from luxury cars to yachts and RVs – allowing us
              to provide deeper insights and more specialized options for each
              category.
            </p>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-neutral-800 mb-4">
              We're dedicated to helping you find the perfect vehicle for every
              journey, whether it's a practical car for everyday adventures, a
              luxurious yacht for special occasions, or anything in between.
            </p>
            <p className="text-neutral-800 mb-4">
              By partnering with leading rental providers worldwide, we offer
              you unmatched selection and competitive pricing across all vehicle
              categories.
            </p>
